...
The sources for lunchtime can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/robertopreste/lunchtime
.. _tarball: https://github.com/robertopreste/lunchtime/tarball/master
